      ...
      <div className="flex items-center flex-1">
        ...
        <form onSubmit={handleSearch} className="hidden md:flex relative w-full max-w-xs">
          ...
          <input
            ...
            className="block w-full pl-10 pr-4 py-2.5 rounded-lg bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent text-base"
          />
        </form>
      </div>
